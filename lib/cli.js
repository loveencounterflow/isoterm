(function() {
  'use strict';
  var CND, CP, GUY, H, PATH, badge, debug, demo_websocket, echo, get_screen_dimensions, help, info, parse_arguments, port_pattern, rpr, run, start_browser, start_path, start_server, start_server_in_own_process, urge, warn, whisper, xterm_path;
  ...
  //-----------------------------------------------------------------------------------------------------------
  start_server_in_own_process = function() {
    return new Promise(async(resolve, reject) => {
