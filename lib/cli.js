(function() {
  ...
  start_server = function() {
    return new Promise(async(resolve, reject) => {
      var conclude, cp_cfg, env, port, server, signals;
      port = null;
      signals = {
        webpack: false,
        server: false,
      ...
      server.on('error', (error) => {
        return warn('^server@445-1^', error);
      });
      //.........................................................................................................
      server.on('message', (d) => {
        var ref;
  ...
  start_browser = function(cfg) {
    return new Promise((resolve, reject) => {
      ...
      browser.on('error', (error) => {
        return warn('^browser@445-13^', error);
      });
      browser.on('close', () => {
        return whisper('^browser@445-14^', 'close');
      });
      browser.on('disconnect', () => {
        return whisper('^browser@445-15^', 'disconnect');
      });
      browser.on('error', () => {
        return whisper('^browser@445-16^', 'error');
      });
      browser.on('message', () => {
        return whisper('^browser@445-17^', 'message');
      });
      browser.on('spawn', () => {
        return whisper('^browser@445-18^', 'spawn');
      });
      browser.on('exit', () => {
