(function() {
  'use strict';
  var CND, CP, H, PATH, badge, debug, demo_websocket, echo, help, info, parse_arguments, port_pattern, rpr, run, start_browser, start_path, start_server, urge, warn, whisper, xterm_path;
  ...
  start_server = function() {
    return new Promise(async(resolve, reject) => {
      var PORT, conclude, cp_cfg, port, server, signals;
      port = null;
      signals = {
        webpack: false,
        server: false,
