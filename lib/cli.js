(function() {
  'use strict';
  var CND, CP, GUY, H, PATH, _start_server, badge, debug, demo_websocket, echo, get_screen_dimensions, help, info, parse_arguments, port_pattern, rpr, run, start_browser, start_server, urge, warn, whisper, xterm_path;
