(function() {
  'use strict';
  var Combokeys, Intercepted_console, _console, ckeys, count;
  ...
  ckeys.bind('ctrl+y', function(event, key) {
    return log('^ops@756^', event);
  });

  ckeys.bind('ctrl+k', function(event, key) {
  ...
  ckeys.bind('ctrl+l', function(event, key) {
